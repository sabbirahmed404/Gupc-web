  ...
  return (
    <>
      ...
      <div className="relative bg-fixed bg-center bg-cover custom-img" style={{ marginTop: 0 }}>
        ...
        <div className="flex items-center justify-center h-[30vh] flex-col" style={{ paddingTop: '120px' }}>
        ...
        <div className="relative pb-16 z-[1] flex justify-center" style={{ marginTop: '60px' }}>
